        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderMatricule = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Weighting = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ResultIndicator = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Resultat = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ValidatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "HistoryUserindicatorFis",
                columns: table => new
                {
                    HistoryUserindicatorFiId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserEvalId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryUserindicatorFis", x => x.HistoryUserindicatorFiId);
                    table.ForeignKey(
                        name: "FK_HistoryUserindicatorFis_UserEvaluations_UserEvalId",
                        column: x => x.UserEvalId,
                        principalTable: "UserEvaluations",
                        principalColumn: "UserEvalId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryUserindicatorFis_UserEvalId",
