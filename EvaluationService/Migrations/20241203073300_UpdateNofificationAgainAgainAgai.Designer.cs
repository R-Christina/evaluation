...
namespace EvaluationService.Migrations
{
    ...
    [Migration("20241203073300_UpdateNofificationAgainAgainAgai")]
    partial class UpdateNofificationAgainAgainAgai
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvaluationService.Models.Help", b =>
                {
                    ...
                    b.Property<int>("AllowedUserLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EvaluationService.Models.HistoryUserHelpContent", b =>
                {
                    b.Property<int>("HistoryContentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HistoryContentId"));
                    ...
                    b.HasKey("HistoryContentId");

                    b.ToTable("HistoryUserHelpContents");
                });
