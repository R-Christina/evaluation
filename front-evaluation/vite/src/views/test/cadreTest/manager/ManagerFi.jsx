...
function ManagerFi() {
  ...
  const validateStep = () => {
    ...
    for (const [index, objective] of currentPriority.objectives.entries()) {
      ...
      if (
        isAnyDynamicColumnFilled &&
        (!objective.description || !objective.weighting || !objective.resultIndicator || !objective.result)
      ) {
                  ...
                  onClick={() => {
                    if (validateStep()) {
                      ...
                      if (!signatureFile) {
                        ...
                        validateFinalObjectif(); // Appeler la fonction de validation
                      }
                    }
                  }}
                >
