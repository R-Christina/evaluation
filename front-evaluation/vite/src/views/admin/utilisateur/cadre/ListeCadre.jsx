...
const ListeCadre = () => {
  ...
  const fetchFilteredUsers = async (nameOrMail, department) => {
    try {
      const response = await authInstance.get('/User/all-cadre', {
        params: {
  ...
  const handleAddClick = (userId) => {
    navigate(`/utilisateur/assignation/${userId}`);
  };
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            ...
            <Button
              ...
              sx={{ marginLeft: 2 }}
              onClick={() => navigate('/utilisateur/assignAllCadre')}
            >
              Assigner
            </Button>
          </Grid>
