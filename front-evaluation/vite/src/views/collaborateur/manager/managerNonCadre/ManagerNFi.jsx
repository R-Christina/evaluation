...
function ManagerNFi({ subordinateId, typeUser }) {
  ...
  const steps = [...indicators.map((indicator) => indicator.label), 'Plan de Développement Professionnel'];
                  ...
                  <Card>
                    <CardContent>
                      ...
                      <Paper sx={{ p: 3, border: '1px solid #ccc', backgroundColor: '#e8eaf6' }}>
                        ...
                        <Typography variant="subtitle1" gutterBottom sx={{ mb: 2, mt:3, fontWeight: 'semi-bold' }}>
                      ...
                      <Paper sx={{ p: 3, border: '1px solid #ccc', backgroundColor: '#e8eaf6' }}>
                        <Box mt={2}>
                          {loadingHelps ? (
                            ...
                            <Grid container spacing={3}>
                              {helps.map((help) => (
                                <Grid item xs={12} key={help.helpId}>
                                  <Typography variant="subtitle1" gutterBottom sx={{ mb: 2, fontWeight: 'bold' }}>
                                    {help.name}
                                  </Typography>
                                  <Card sx={{ padding: 2, borderRadius: 2, backgroundColor: '#ffffff' }}>
                                    <CardContent>
                                      <TextField
                                        fullWidth
                                        label={help.name}
