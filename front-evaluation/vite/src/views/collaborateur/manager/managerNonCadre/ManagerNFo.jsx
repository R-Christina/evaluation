...
function ManagerNFO() {
  ...
  return (
    <Paper>
      ...
      {/* Période Mi-Parcours */}
      {currentPeriod === 'Mi-Parcours' && <ManagerNMp subordinateId={subordinateId} typeUser={typeUser} />}

      {/* Période Évaluation Finale */}
      {currentPeriod === 'Évaluation Finale' && <ManagerNFi subordinateId={subordinateId} typeUser={typeUser} />}
