  ...
  const handleObjectiveChange = (groupName, index, field, value, colIndex = null) => {
    ...
    if (colIndex !== null && field === "objectiveColumnValues") {
      ...
      updatedGroupedObjectives[groupName][index] = {
        ...updatedGroupedObjectives[groupName][index],
        objectiveColumnValues: updatedGroupedObjectives[groupName][index].objectiveColumnValues.map(
          (column, i) => (i === colIndex ? { ...column, value } : column)
        ),
      };
    } else {
        ...
        {loading ? (
          ...
          <>
            {Object.keys(groupedObjectives).length > 0 ? (
                        ...
                        <Box>
                          ...
                          {currentPeriod === 'Fixation Objectif' && (
                            <Typography variant="caption" sx={{ color: 'gray', mt: -1 }}>
                              ...
                              Ce champ ne peut pas être modifié pendant la période de fixation.
                            </Typography>
                          )}
                          <TextField
              ...
              <Alert severity="info">Aucun objectif utilisateur trouvé.</Alert>
            )}
          </>
        )}
